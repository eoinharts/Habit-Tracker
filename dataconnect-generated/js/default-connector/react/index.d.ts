...
export function useDeleteFriend(options?: useDataConnectMutationOptions<DeleteFriendData, FirebaseError, DeleteFriendVariables>): UseMutationResult<FlattenedMutationResult<DeleteFriendData, DeleteFriendVariables>, FirebaseError, DeleteFriendVariables>;
export function useDeleteFriend(dc: DataConnect, options?: useDataConnectMutationOptions<DeleteFriendData, FirebaseError, DeleteFriendVariables>): UseMutationResult<FlattenedMutationResult<DeleteFriendData, DeleteFriendVariables>, FirebaseError, DeleteFriendVariables>;

export function useRemoveReverseFriend(options?: useDataConnectMutationOptions<RemoveReverseFriendData, FirebaseError, RemoveReverseFriendVariables>): UseMutationResult<FlattenedMutationResult<RemoveReverseFriendData, RemoveReverseFriendVariables>, FirebaseError, RemoveReverseFriendVariables>;
export function useRemoveReverseFriend(dc: DataConnect, options?: useDataConnectMutationOptions<RemoveReverseFriendData, FirebaseError, RemoveReverseFriendVariables>): UseMutationResult<FlattenedMutationResult<RemoveReverseFriendData, RemoveReverseFriendVariables>, FirebaseError, RemoveReverseFriendVariables>;
...
export function useListFriends(vars: ListFriendsVariables, options?: useDataConnectQueryOptions<ListFriendsData>): UseQueryResult<FlattenedQueryResult<ListFriendsData, ListFriendsVariables>, FirebaseError>;
export function useListFriends(dc: DataConnect, vars: ListFriendsVariables, options?: useDataConnectQueryOptions<ListFriendsData>): UseQueryResult<FlattenedQueryResult<ListFriendsData, ListFriendsVariables>, FirebaseError>;
...
export function useDebugFriendships(options?: useDataConnectQueryOptions<DebugFriendshipsData>): UseQueryResult<FlattenedQueryResult<DebugFriendshipsData, undefined>, FirebaseError>;
export function useDebugFriendships(dc: DataConnect, options?: useDataConnectQueryOptions<DebugFriendshipsData>): UseQueryResult<FlattenedQueryResult<DebugFriendshipsData, undefined>, FirebaseError>;

...
export function useListMyAchievements(options?: useDataConnectQueryOptions<ListMyAchievementsData>): UseDataConnectQueryResult<ListMyAchievementsData, undefined>;
export function useListMyAchievements(dc: DataConnect, options?: useDataConnectQueryOptions<ListMyAchievementsData>): UseDataConnectQueryResult<ListMyAchievementsData, undefined>;

export function useListUserAchievements(options?: useDataConnectQueryOptions<ListUserAchievementsData>): UseDataConnectQueryResult<ListUserAchievementsData, undefined>;
export function useListUserAchievements(dc: DataConnect, options?: useDataConnectQueryOptions<ListUserAchievementsData>): UseDataConnectQueryResult<ListUserAchievementsData, undefined>;
